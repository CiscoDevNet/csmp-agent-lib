...
#define MBED_CONF_APP_WISUN_BC_CHANNEL_FUNCTION                               0                                                                                                // set by application
#define MBED_CONF_APP_WISUN_BC_DWELL_INTERVAL                                 255                                                                                              // set by application
#define MBED_CONF_APP_WISUN_BC_FIXED_CHANNEL                                  11                                                                                               // set by application
#define MBED_CONF_APP_WISUN_BC_INTERVAL                                       1020                                                                                             // set by application
#define MBED_CONF_APP_WISUN_UC_CHANNEL_FUNCTION                               0                                                                                                // set by application
#define MBED_CONF_APP_WISUN_UC_FIXED_CHANNEL                                  11                                                                                               // set by application
