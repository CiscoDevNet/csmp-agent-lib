...
#define MBED_CONF_MBED_MESH_API_CERTIFICATE_HEADER                            "ws_router_fan_cert_certificates.h"
#define MBED_CONF_MBED_MESH_API_OWN_CERTIFICATE                               WISUN_CLIENT_GS_CERTIFICATE
#define MBED_CONF_MBED_MESH_API_OWN_CERTIFICATE_KEY                           WISUN_CLIENT_GS_KEY
