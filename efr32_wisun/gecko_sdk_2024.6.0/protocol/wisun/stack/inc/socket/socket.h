...
/**
 * @brief Receive a message from a connection-mode or connectionless-mode socket.
 ...
 * @param message Points to a msghdr structure, containing both the
...
/**
 * @brief Returns the next control message header in a message header structure.
 * @param msgh A pointer to a msghdr_t structure that contains the ancillary data buffer.
 * @param cmsg A pointer to a cmsghdr_t structure that represents the current control message header.
 * @return A pointer to the next control message header, or NULL if there are no more control messages in the buffer.
