...
/***************************************************************************//**
 * Enables/Disables the peripheral clock associated with the given peripheral.
 ******************************************************************************/
sl_status_t sli_clock_manager_hal_enable_peripheral_clock(sl_clock_manager_peripheral_clock_t peripheral, bool enable)
{
  (void)peripheral;
  (void)enable;
  return SL_STATUS_NOT_SUPPORTED;
...
/***************************************************************************//**
 * Configure the exported clock feature on CMU to output user selected
...
/***************************************************************************//**
 * Set HFXO frequency tuning control.
 ******************************************************************************/
...
/***************************************************************************//**
 * Set LFXO frequency tuning control.
 ******************************************************************************/
