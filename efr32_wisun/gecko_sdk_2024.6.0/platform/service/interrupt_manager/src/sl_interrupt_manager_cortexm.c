...
#include "sl_interrupt_manager_s3_config.h"
#endif
...
#define SL_INTERRUPT_MANAGER_DEFAULT_PRIORITY 3U
...
#if defined(VECTOR_TABLE_IN_RAM) && defined(SL_INTERRUPT_MANAGER_HOOKS) && (SL_INTERRUPT_MANAGER_HOOKS == 1)
