 ...
 *
 *****************************************************************************/
#ifndef SL_DEVICE_ABSTRACTION_PERIPHERAL_H
#define SL_DEVICE_ABSTRACTION_PERIPHERAL_H
...
/***************************************************************************//**
 * @addtogroup device_abstraction_peripheral Device Abstraction Peripheral
 * @{
 ******************************************************************************/
...
typedef struct sl_peripheral {
  uint32_t base;   ///< Peripheral base address. Non Secure address always.
...
/// Secure address mask.
#define SL_SECURE_ADDR_MASK 0xEFFFFFFF

/// Macro to convert non-secure peripheral base address to secure address.
#define SL_GET_SECURE_ADDR(addr) (((uint32_t)addr) & SL_SECURE_ADDR_MASK)

/// Macro to convert secure peripheral base address to non-secure address.
#define SL_GET_NON_SECURE_ADDR(addr) (((uint32_t)addr) | ~SL_SECURE_ADDR_MASK)
...
/** @} (end addtogroup device_abstraction_peripheral) */

#ifdef __cplusplus
}
#endif

#endif // SL_DEVICE_ABSTRACTION_PERIPHERAL_H
