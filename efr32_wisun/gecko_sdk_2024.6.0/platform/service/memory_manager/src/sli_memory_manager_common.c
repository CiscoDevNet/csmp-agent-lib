...
#if defined(SLI_MEMORY_MANAGER_ENABLE_TEST_UTILITIES) || (defined(SL_CATALOG_MEMORY_PROFILER_PRESENT) && SL_MEMORY_PROFILER_SELECTION)
...
#ifdef SLI_MEMORY_MANAGER_ENABLE_TEST_UTILITIES
/***************************************************************************//**
 * Get the index in sli_reservation_handle_ptr_table by block address.
 *
...
/***************************************************************************//**
 * Get the index in sli_reservation_handle_ptr_table
 * by reservation handle pointer.
 *
 * @param[in]  addr  Pointer to reservation handle.
 *
 * @return    Corresponding index in sli_reservation_handle_ptr_table.
 ******************************************************************************/
...
/***************************************************************************//**
 * Get the index in sli_reservation_no_retention_table by block address.
 *
 * @param[in]  addr  Pointer to block reservation.
 *
...
/***************************************************************************//**
 * Get an index of sli_reservation_no_retention_table that is free.
 *
...
/***************************************************************************//**
 * Get pointer pointing to the first free block of adequate size.
 *
...
/***************************************************************************//**
 * Get long-term head pointer pointing to the first free block.
 ******************************************************************************/
...
/***************************************************************************//**
 * Get short-term head pointer pointing to the first free block.
 ******************************************************************************/
...
#ifdef SLI_MEMORY_MANAGER_ENABLE_TEST_UTILITIES
/***************************************************************************//**
 * Get the ptr to sl_memory_reservation_t by block address.
 ******************************************************************************/
...
/***************************************************************************//**
 * Get the size of a reservation by block address.
 ******************************************************************************/
...
/***************************************************************************//**
 * Bookkeep a reservation for profiling purposes.
 ******************************************************************************/
sl_status_t sli_memory_save_reservation_handle(sl_memory_reservation_t *reservation_handle_ptr, uint32_t align)
{
  uint32_t reservation_ix = -1;
...
/***************************************************************************//**
 * Remove a reservation from records.
 ******************************************************************************/
...
/***************************************************************************//**
 * Get the size of a reservation (no retention) by block address.
 ******************************************************************************/
...
/***************************************************************************//**
 * Get the alignment of a reservation (no retention) by block address.
 ******************************************************************************/
...
/***************************************************************************//**
 * Do a heap integrity check forwards from sli_free_lt_list_head and return
 * the ptr to the corrupted sli_block_metadata_t (if applicable).
...
sli_block_metadata_t *sli_memory_check_heap_integrity_forwards(void)
{
  ...
  while (current != NULL) {
    ...
    if (current->offset_neighbour_next == 0) {
      ...
      if (heap_end_by_metadata != (void *)__HeapLimit) {
        is_corrupted = 1;
      }
      break;
    }
...
/***************************************************************************//**
 * Do a heap integrity check backwards from sli_free_st_list_head and return
 * the ptr to the corrupted sli_block_metadata_t (if applicable).
...
sli_block_metadata_t *sli_memory_check_heap_integrity_backwards(void)
{
  ...
  while (current != NULL) {
    ...
    if (current->offset_neighbour_prev == 0) {
      ...
      if (heap_base_by_metadata != (void *)__HeapBase) {
        is_corrupted = 1;
      }
      break;
    }
