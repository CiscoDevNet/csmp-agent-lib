 ...
 *****************************************************************************/
/**
 * @addtogroup PTI_Packet_Trace PTI Packet Trace
 * @{
 *
...
RAIL_ENUM(RAIL_RxPacketStatus_t) {
  ...
  /**
   * A packet is being received and dropped internally.
   */
  RAIL_RX_PACKET_DROPPED = 9,
};
...
#define RAIL_RX_PACKET_DROPPED         ((RAIL_RxPacketStatus_t) RAIL_RX_PACKET_DROPPED)
#endif//DOXYGEN_SHOULD_SKIP_THIS
...
typedef struct RAIL_VdetConfig {
  ...
  /** Delay in us for the capture from Tx Start in \ref RAIL_VDET_MODE_AUTOMATIC. */
  uint32_t delayUs;
} RAIL_VdetConfig_t;
