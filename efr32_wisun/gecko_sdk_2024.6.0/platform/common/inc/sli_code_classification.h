...
#define _SL_CC_CONCAT(A, B) A B

/******************************************************************************/
/* Compiler Specific Macros                                                   */
/******************************************************************************/

// The directive that is built is dependent on the compiler.
#if defined(__GNUC__) && !defined(__llvm__)

// With GCC, __attribute__ can be used to specify the input section of
// functions.
#define _SL_CC_SECTION(section_name) \
  __attribute__((section(_SL_CC_STRINGIZE(section_name))))
...
// functions.
#define _SL_CC_SECTION(section_name) \
  _Pragma(_SL_CC_XSTRINGIZE(_SL_CC_CONCAT(location =, _SL_CC_XSTRINGIZE(section_name))))
...
#define _SL_CODE_CLASS1(component, c1) \
  _SL_CC_SECTION(_SL_CODE_CLASS_SECTION_CONCAT1(component, c1))
#define _SL_CODE_CLASS2(component, c1, c2) \
  _SL_CC_SECTION(_SL_CODE_CLASS_SECTION_CONCAT2(component, c1, c2))
