 ...
 *   are disabled.
 *
 * @deprecated Will be removed from the SiSDK
 *
 * @param[out] nvicState
 ...
 *
 * @deprecated Will be removed from the SiSDK, please now use the function
 *  sl_interrupt_manager_is_irq_disabled in the interrupt manager
 *  service component.
 *
 * @param[in] irqN
 ...
 *
 * @deprecated Will be removed from the SiSDK, please now use the function
 *  sl_interrupt_manager_set_irq_handler in the interrupt manager
 *  service component.
 *
 * @param[in] irqN
 *   The IRQn_Type enumerator for the interrupt.
 ...
 *
 * @deprecated Will be removed from the SiSDK, please now use the function
 *  sl_interrupt_manager_is_irq_blocked in the interrupt manager
 *  service component.
 *
 * @param[in] irqN
 *   The IRQn_Type enumerator for the interrupt to check.
