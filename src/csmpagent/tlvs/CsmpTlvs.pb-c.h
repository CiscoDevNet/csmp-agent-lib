...
typedef struct TlvIndex TlvIndex;
typedef struct DeviceID DeviceID;
typedef struct SessionID SessionID;
typedef struct DescriptionRequest DescriptionRequest;
typedef struct ReportSubscribe ReportSubscribe;
typedef struct CGMSSettings CGMSSettings;
typedef struct CGMSStatus CGMSStatus;
typedef struct CGMSStats CGMSStats;
typedef struct GroupAssign GroupAssign;
typedef struct GroupMatch GroupMatch;
typedef struct GroupInfo GroupInfo;
typedef struct SignatureValidity SignatureValidity;
typedef struct Signature Signature;
typedef struct HardwareDesc HardwareDesc;
typedef struct InterfaceDesc InterfaceDesc;
typedef struct IPAddress IPAddress;
typedef struct IPRoute IPRoute;
typedef struct CurrentTime CurrentTime;
typedef struct Uptime Uptime;
typedef struct InterfaceMetrics InterfaceMetrics;
typedef struct IPRouteRPLMetrics IPRouteRPLMetrics;
typedef struct WPANStatus WPANStatus;
typedef struct RPLInstance RPLInstance;
typedef struct HardwareInfo HardwareInfo;
typedef struct FirmwareImageInfo FirmwareImageInfo;
...
typedef enum {
  ...
  DEVICE_ID__TYPE_PRESENT_TYPE = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(DEVICE_ID__TYPE_PRESENT__CASE)
} DeviceID__TypePresentCase;

typedef enum {
  DEVICE_ID__ID_PRESENT__NOT_SET = 0,
  DEVICE_ID__ID_PRESENT_ID = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(DEVICE_ID__ID_PRESENT__CASE)
...
typedef enum {
  ...
  SESSION_ID__ID_PRESENT_ID = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(SESSION_ID__ID_PRESENT__CASE)
...
typedef enum {
  ...
  REPORT_SUBSCRIBE__INTERVAL_PRESENT_INTERVAL = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(REPORT_SUBSCRIBE__INTERVAL_PRESENT__CASE)
} ReportSubscribe__IntervalPresentCase;

/*
 * TLV 13
 */
struct  ReportSubscribe
{
  ProtobufCMessage base;
  size_t n_tlvid;
  char **tlvid;
...
typedef enum {
  ...
  CGMSSETTINGS__REG_INTERVAL_MIN_PRESENT_REG_INTERVAL_MIN = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSETTINGS__REG_INTERVAL_MIN_PRESENT__CASE)
...
typedef enum {
  ...
  CGMSSETTINGS__REG_INTERVAL_MAX_PRESENT_REG_INTERVAL_MAX = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSETTINGS__REG_INTERVAL_MAX_PRESENT__CASE)
...
typedef enum {
  ...
  CGMSSTATUS__REGISTERED_PRESENT_REGISTERED = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATUS__REGISTERED_PRESENT__CASE)
} CGMSStatus__RegisteredPresentCase;

typedef enum {
  CGMSSTATUS__NMSADDR_PRESENT__NOT_SET = 0,
  CGMSSTATUS__NMSADDR_PRESENT_NMSADDR = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATUS__NMSADDR_PRESENT__CASE)
...
typedef enum {
  ...
  CGMSSTATUS__NMSADDR_ORIGIN_PRESENT_NMSADDR_ORIGIN = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATUS__NMSADDR_ORIGIN_PRESENT__CASE)
} CGMSStatus__NMSAddrOriginPresentCase;

typedef enum {
  CGMSSTATUS__LAST_REG_PRESENT__NOT_SET = 0,
  CGMSSTATUS__LAST_REG_PRESENT_LAST_REG = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATUS__LAST_REG_PRESENT__CASE)
...
typedef enum {
  ...
  CGMSSTATUS__LAST_REG_REASON_PRESENT_LAST_REG_REASON = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATUS__LAST_REG_REASON_PRESENT__CASE)
} CGMSStatus__LastRegReasonPresentCase;

typedef enum {
  CGMSSTATUS__NEXT_REG_PRESENT__NOT_SET = 0,
  CGMSSTATUS__NEXT_REG_PRESENT_NEXT_REG = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATUS__NEXT_REG_PRESENT__CASE)
...
typedef enum {
  ...
  CGMSSTATUS__NMSCERT_VALID_PRESENT_NMSCERT_VALID = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATUS__NMSCERT_VALID_PRESENT__CASE)
...
typedef enum {
  ...
  CGMSSTATS__SIG_OK_PRESENT_SIG_OK = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATS__SIG_OK_PRESENT__CASE)
} CGMSStats__SigOkPresentCase;

typedef enum {
  CGMSSTATS__SIG_BAD_AUTH_PRESENT__NOT_SET = 0,
  CGMSSTATS__SIG_BAD_AUTH_PRESENT_SIG_BAD_AUTH = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATS__SIG_BAD_AUTH_PRESENT__CASE)
...
typedef enum {
  ...
  CGMSSTATS__SIG_BAD_VALIDITY_PRESENT_SIG_BAD_VALIDITY = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CGMSSTATS__SIG_BAD_VALIDITY_PRESENT__CASE)
...
typedef enum {
  ...
  GROUP_ASSIGN__TYPE_PRESENT_TYPE = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GROUP_ASSIGN__TYPE_PRESENT__CASE)
} GroupAssign__TypePresentCase;

typedef enum {
  GROUP_ASSIGN__ID_PRESENT__NOT_SET = 0,
  GROUP_ASSIGN__ID_PRESENT_ID = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GROUP_ASSIGN__ID_PRESENT__CASE)
...
typedef enum {
  ...
  GROUP_MATCH__TYPE_PRESENT_TYPE = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GROUP_MATCH__TYPE_PRESENT__CASE)
} GroupMatch__TypePresentCase;

typedef enum {
  GROUP_MATCH__ID_PRESENT__NOT_SET = 0,
  GROUP_MATCH__ID_PRESENT_ID = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GROUP_MATCH__ID_PRESENT__CASE)
...
typedef enum {
  ...
  GROUP_INFO__TYPE_PRESENT_TYPE = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GROUP_INFO__TYPE_PRESENT__CASE)
} GroupInfo__TypePresentCase;

typedef enum {
  GROUP_INFO__ID_PRESENT__NOT_SET = 0,
  GROUP_INFO__ID_PRESENT_ID = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GROUP_INFO__ID_PRESENT__CASE)
...
typedef enum {
  ...
  SIGNATURE_VALIDITY__NOT_BEFORE_PRESENT_NOT_BEFORE = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(SIGNATURE_VALIDITY__NOT_BEFORE_PRESENT__CASE)
...
typedef enum {
  ...
  SIGNATURE_VALIDITY__NOT_AFTER_PRESENT_NOT_AFTER = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(SIGNATURE_VALIDITY__NOT_AFTER_PRESENT__CASE)
} SignatureValidity__NotAfterPresentCase;

/*
 * TLV 76
 */
struct  SignatureValidity
{
  ProtobufCMessage base;
...
typedef enum {
  ...
  SIGNATURE__VALUE_PRESENT_VALUE = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(SIGNATURE__VALUE_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_INDEX_PRESENT_ENT_PHYSICAL_INDEX = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_DESCR_PRESENT_ENT_PHYSICAL_DESCR = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_DESCR_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_VENDOR_TYPE_PRESENT_ENT_PHYSICAL_VENDOR_TYPE = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_VENDOR_TYPE_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_CONTAINED_IN_PRESENT_ENT_PHYSICAL_CONTAINED_IN = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_CONTAINED_IN_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_CLASS_PRESENT_ENT_PHYSICAL_CLASS = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_CLASS_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_PARENT_REL_POS_PRESENT_ENT_PHYSICAL_PARENT_REL_POS = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_PARENT_REL_POS_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_NAME_PRESENT_ENT_PHYSICAL_NAME = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_NAME_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_HARDWARE_REV_PRESENT_ENT_PHYSICAL_HARDWARE_REV = 8
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_HARDWARE_REV_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_FIRMWARE_REV_PRESENT_ENT_PHYSICAL_FIRMWARE_REV = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_FIRMWARE_REV_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_SOFTWARE_REV_PRESENT_ENT_PHYSICAL_SOFTWARE_REV = 10
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_SOFTWARE_REV_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_SERIAL_NUM_PRESENT_ENT_PHYSICAL_SERIAL_NUM = 11
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_SERIAL_NUM_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_MFG_NAME_PRESENT_ENT_PHYSICAL_MFG_NAME = 12
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_MFG_NAME_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_MODEL_NAME_PRESENT_ENT_PHYSICAL_MODEL_NAME = 13
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_MODEL_NAME_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_ASSET_ID_PRESENT_ENT_PHYSICAL_ASSET_ID = 14
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_ASSET_ID_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_MFG_DATE_PRESENT_ENT_PHYSICAL_MFG_DATE = 15
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_MFG_DATE_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_URIS_PRESENT_ENT_PHYSICAL_URIS = 16
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_URIS_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_FUNCTION_PRESENT_ENT_PHYSICAL_FUNCTION = 17
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_FUNCTION_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_DESC__ENT_PHYSICAL_OUI_PRESENT_ENT_PHYSICAL_OUI = 18
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_DESC__ENT_PHYSICAL_OUI_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_DESC__IF_PHYS_ADDRESS_PRESENT_IF_PHYS_ADDRESS = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_DESC__IF_PHYS_ADDRESS_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_INDEX_PRESENT_IP_ADDRESS_INDEX = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_ADDR_TYPE_PRESENT_IP_ADDRESS_ADDR_TYPE = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_ADDR_TYPE_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_ADDR_PRESENT_IP_ADDRESS_ADDR = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_ADDR_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_IF_INDEX_PRESENT_IP_ADDRESS_IF_INDEX = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_IF_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_TYPE_PRESENT_IP_ADDRESS_TYPE = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_TYPE_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_ORIGIN_PRESENT_IP_ADDRESS_ORIGIN = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_ORIGIN_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_STATUS_PRESENT_IP_ADDRESS_STATUS = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_STATUS_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_CREATED_PRESENT_IP_ADDRESS_CREATED = 8
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_CREATED_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_LAST_CHANGED_PRESENT_IP_ADDRESS_LAST_CHANGED = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_LAST_CHANGED_PRESENT__CASE)
...
typedef enum {
  ...
  IPADDRESS__IP_ADDRESS_PFX_LEN_PRESENT_IP_ADDRESS_PFX_LEN = 10
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPADDRESS__IP_ADDRESS_PFX_LEN_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_INDEX_PRESENT_INET_CIDR_ROUTE_INDEX = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_DEST_TYPE_PRESENT_INET_CIDR_ROUTE_DEST_TYPE = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_DEST_TYPE_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_DEST_PRESENT_INET_CIDR_ROUTE_DEST = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_DEST_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_PFX_LEN_PRESENT_INET_CIDR_ROUTE_PFX_LEN = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_PFX_LEN_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_NEXT_HOP_TYPE_PRESENT_INET_CIDR_ROUTE_NEXT_HOP_TYPE = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_NEXT_HOP_TYPE_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_NEXT_HOP_PRESENT_INET_CIDR_ROUTE_NEXT_HOP = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_NEXT_HOP_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_IF_INDEX_PRESENT_INET_CIDR_ROUTE_IF_INDEX = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_IF_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_TYPE_PRESENT_INET_CIDR_ROUTE_TYPE = 8
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_TYPE_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_PROTO_PRESENT_INET_CIDR_ROUTE_PROTO = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_PROTO_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE__INET_CIDR_ROUTE_AGE_PRESENT_INET_CIDR_ROUTE_AGE = 10
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE__INET_CIDR_ROUTE_AGE_PRESENT__CASE)
...
typedef enum {
  ...
  CURRENT_TIME__POSIX_PRESENT_POSIX = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CURRENT_TIME__POSIX_PRESENT__CASE)
} CurrentTime__PosixPresentCase;

typedef enum {
  CURRENT_TIME__ISO8601_PRESENT__NOT_SET = 0,
  CURRENT_TIME__ISO8601_PRESENT_ISO8601 = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CURRENT_TIME__ISO8601_PRESENT__CASE)
} CurrentTime__Iso8601PresentCase;

typedef enum {
  CURRENT_TIME__SOURCE_PRESENT__NOT_SET = 0,
  CURRENT_TIME__SOURCE_PRESENT_SOURCE = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CURRENT_TIME__SOURCE_PRESENT__CASE)
...
typedef enum {
  ...
  UPTIME__SYS_UP_TIME_PRESENT_SYS_UP_TIME = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(UPTIME__SYS_UP_TIME_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_INDEX_PRESENT_IF_INDEX = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_IN_SPEED_PRESENT_IF_IN_SPEED = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_IN_SPEED_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_OUT_SPEED_PRESENT_IF_OUT_SPEED = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_OUT_SPEED_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_ADMIN_STATUS_PRESENT_IF_ADMIN_STATUS = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_ADMIN_STATUS_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_OPER_STATUS_PRESENT_IF_OPER_STATUS = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_OPER_STATUS_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_LAST_CHANGE_PRESENT_IF_LAST_CHANGE = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_LAST_CHANGE_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_IN_OCTETS_PRESENT_IF_IN_OCTETS = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_IN_OCTETS_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_OUT_OCTETS_PRESENT_IF_OUT_OCTETS = 8
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_OUT_OCTETS_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_IN_DISCARDS_PRESENT_IF_IN_DISCARDS = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_IN_DISCARDS_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_IN_ERRORS_PRESENT_IF_IN_ERRORS = 10
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_IN_ERRORS_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_OUT_DISCARDS_PRESENT_IF_OUT_DISCARDS = 11
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_OUT_DISCARDS_PRESENT__CASE)
...
typedef enum {
  ...
  INTERFACE_METRICS__IF_OUT_ERRORS_PRESENT_IF_OUT_ERRORS = 12
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INTERFACE_METRICS__IF_OUT_ERRORS_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__INET_CIDR_ROUTE_INDEX_PRESENT_INET_CIDR_ROUTE_INDEX = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__INET_CIDR_ROUTE_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__INSTANCE_INDEX_PRESENT_INSTANCE_INDEX = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__INSTANCE_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__RANK_PRESENT_RANK = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__RANK_PRESENT__CASE)
} IPRouteRPLMetrics__RankPresentCase;

typedef enum {
  IPROUTE_RPLMETRICS__HOPS_PRESENT__NOT_SET = 0,
  IPROUTE_RPLMETRICS__HOPS_PRESENT_HOPS = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__HOPS_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__PATH_ETX_PRESENT_PATH_ETX = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__PATH_ETX_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__LINK_ETX_PRESENT_LINK_ETX = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__LINK_ETX_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__RSSI_FORWARD_PRESENT_RSSI_FORWARD = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__RSSI_FORWARD_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__RSSI_REVERSE_PRESENT_RSSI_REVERSE = 8
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__RSSI_REVERSE_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__LQI_FORWARD_PRESENT_LQI_FORWARD = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__LQI_FORWARD_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__LQI_REVERSE_PRESENT_LQI_REVERSE = 10
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__LQI_REVERSE_PRESENT__CASE)
...
typedef enum {
  ...
  IPROUTE_RPLMETRICS__DAG_SIZE_PRESENT_DAG_SIZE = 11
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(IPROUTE_RPLMETRICS__DAG_SIZE_PRESENT__CASE)
} IPRouteRPLMetrics__DagSizePresentCase;

/*
 * TLV 25
 */
struct  IPRouteRPLMetrics
{
  ProtobufCMessage base;
...
typedef enum {
  ...
  WPANSTATUS__DOT1X_ENABLED_PRESENT_DOT1X_ENABLED = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(WPANSTATUS__DOT1X_ENABLED_PRESENT__CASE)
...
typedef enum {
  ...
  WPANSTATUS__SECURITY_LEVEL_PRESENT_SECURITY_LEVEL = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(WPANSTATUS__SECURITY_LEVEL_PRESENT__CASE)
} WPANStatus__SecurityLevelPresentCase;

typedef enum {
  WPANSTATUS__RANK_PRESENT__NOT_SET = 0,
  WPANSTATUS__RANK_PRESENT_RANK = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(WPANSTATUS__RANK_PRESENT__CASE)
} WPANStatus__RankPresentCase;

typedef enum {
  WPANSTATUS__BEACON_VALID_PRESENT__NOT_SET = 0,
  WPANSTATUS__BEACON_VALID_PRESENT_BEACON_VALID = 8
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(WPANSTATUS__BEACON_VALID_PRESENT__CASE)
...
typedef enum {
  ...
  WPANSTATUS__BEACON_VERSION_PRESENT_BEACON_VERSION = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(WPANSTATUS__BEACON_VERSION_PRESENT__CASE)
...
typedef enum {
  ...
  WPANSTATUS__LAST_CHANGED_REASON_PRESENT_LAST_CHANGED_REASON = 15
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(WPANSTATUS__LAST_CHANGED_REASON_PRESENT__CASE)
...
typedef enum {
  ...
  WPANSTATUS__DEMO_MODE_ENABLED_PRESENT_DEMO_MODE_ENABLED = 16
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(WPANSTATUS__DEMO_MODE_ENABLED_PRESENT__CASE)
...
typedef enum {
  ...
  RPLINSTANCE__INSTANCE_INDEX_PRESENT_INSTANCE_INDEX = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(RPLINSTANCE__INSTANCE_INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  RPLINSTANCE__INSTANCE_ID_PRESENT_INSTANCE_ID = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(RPLINSTANCE__INSTANCE_ID_PRESENT__CASE)
} RPLInstance__InstanceIdPresentCase;

typedef enum {
  RPLINSTANCE__DO_DAG_ID_PRESENT__NOT_SET = 0,
  RPLINSTANCE__DO_DAG_ID_PRESENT_DO_DAG_ID = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(RPLINSTANCE__DO_DAG_ID_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_INFO__HW_ID_PRESENT_HW_ID = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_INFO__HW_ID_PRESENT__CASE)
...
typedef enum {
  ...
  HARDWARE_INFO__VENDOR_HW_ID_PRESENT_VENDOR_HW_ID = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(HARDWARE_INFO__VENDOR_HW_ID_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__INDEX_PRESENT_INDEX = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__INDEX_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__FILE_HASH_PRESENT_FILE_HASH = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__FILE_HASH_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__FILE_NAME_PRESENT_FILE_NAME = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__FILE_NAME_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__VERSION_PRESENT_VERSION = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__VERSION_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__FILE_SIZE_PRESENT_FILE_SIZE = 5
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__FILE_SIZE_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__BLOCK_SIZE_PRESENT_BLOCK_SIZE = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__BLOCK_SIZE_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__BITMAP_PRESENT_BITMAP = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__BITMAP_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__IS_DEFAULT_PRESENT_IS_DEFAULT = 8
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__IS_DEFAULT_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__IS_RUNNING_PRESENT_IS_RUNNING = 9
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__IS_RUNNING_PRESENT__CASE)
...
typedef enum {
  ...
  FIRMWARE_IMAGE_INFO__LOAD_TIME_PRESENT_LOAD_TIME = 10
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FIRMWARE_IMAGE_INFO__LOAD_TIME_PRESENT__CASE)
